...
const I18N: I18nService = {
  ...
  strings: {
    ...
    'io_export': { en: 'Export', ru: 'Экспорт' },
    'io_copy': { en: 'Copy', ru: 'Копир.' },
    'io_paste': { en: 'Paste', ru: 'Вставить' },
    'io_import': { en: 'Import', ru: 'Импорт' },
    'io_edges': { en: 'Edges', ru: 'Рёбра' },
    'io_matrix': { en: 'Matrix', ru: 'Матрица' },
    'io_nodes': { en: 'Nodes', ru: 'Узлы' },
